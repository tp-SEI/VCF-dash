                ...
                children=[
                    ...
                    dbc.Modal(
                        [
                            ...
                            dbc.ModalBody("""
                                        Want to know more? Please visit our websites (links below) or email us: Fedra Vanhuyse (fedra.vanhuyse@sei.org, fedra.vanhuyse@viablecities.se) and Tommaso Piseddu (tommaso.piseddu@sei.org)
                                            """),
                            dbc.ModalFooter(
                                [
...
def CAPEX_tbe_costplot(mun, actors, scenario, el_buses, HVO_buses, currentmix_buses, hybridHVO_buses, air_reduction, el_cars,
    ...
    public_transport = ((((cars_givenup/100)*cars_2030*pop_car_ratio/bus_capacity) + buses_2030)*((el_buses/100)*np.mean([5600000, 4730000, 4400000]) + (hybridHVO_buses/100)*2614737) + (((cars_givenup/100)*cars_2030*pop_car_ratio*el_buses/bus_capacity) + buses_2030)*(el_buses/100)*((414990/2) + (912978/20) + (190895/20) + (3319920/20)))/pop.loc[str(mun), 2019]
